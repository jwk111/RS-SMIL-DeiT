...
def download_weights(backbone_type, patch_size, pretrained_type):
    ...
    checkpoints_mae = {
        "vit_base": {16: "https://dl.fbaipublicfiles.com/mae/pretrain/mae_pretrain_vit_base.pth"}
    }
    checkpoints = {"supervised":checkpoints_sup, "dino":checkpoints_dino,"mae":checkpoints_mae}
